...
from clustering.shared import DEFAULT_FEATURES_DIR, default_cluster_results_dir, prepare_dataset
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--cluster-results-dir", default=None, help="Directory containing the clustering outputs. Defaults to cluster_results/<feature_source>/ so pretrained-embedding and audio-feature runs stay separate.")
...
def _build_state(args: argparse.Namespace) -> ExplorerState:
    ...
    resolved_cluster_results_dir = args.cluster_results_dir or default_cluster_results_dir(features_path)
    cluster_results_dir = Path(resolved_cluster_results_dir).resolve()
