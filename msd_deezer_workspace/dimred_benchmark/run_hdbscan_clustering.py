...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default=None, help="Directory for HDBSCAN outputs. Defaults to cluster_results/<feature_source>/<reduction_mode>/hdbscan.")
    parser.add_argument("--limit", type=int, help="Optional cap on how many songs to cluster.")
    parser.add_argument("--random-state", type=int, default=42, help="Random seed for stability metric reproducibility.")
...
def _compute_benchmark_metrics(
    ...
    method = model.cluster_selection_method
...
def main() -> None:
    ...
    resolved_output_dir = args.output_dir or default_algorithm_output_dir(
        args.features_path, "hdbscan", reduction_mode=reduction_mode,
    )
